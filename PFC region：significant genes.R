...
# 处理 sample_1
sample_1 <- Read10X("C:/Seurat_fold(PFC)/H21.33.014_L2_3_IT")
seurat_1 <- CreateSeuratObject(counts = sample_1, project = "H21.33.014_L2_3_IT")
...
# 处理 sample_2
sample_2 <- Read10X("C:/Seurat_fold(PFC)/H21.33.015_L2_3_IT")
seurat_2 <- CreateSeuratObject(counts = sample_2, project = "H21.33.015_L2_3_IT")
...
# 处理 sample_3
sample_3 <- Read10X("C:/Seurat_fold(PFC)/H21.33.016_L2_3_IT")
seurat_3 <- CreateSeuratObject(counts = sample_3, project = "H21.33.016_L2_3_IT")
...
# 处理 sample_4
sample_4 <- Read10X("C:/Seurat_fold(PFC)/H21.33.017_L2_3_IT")
seurat_4 <- CreateSeuratObject(counts = sample_4, project = "H21.33.017_L2_3_IT")
...
# 处理 sample_5
sample_5 <- Read10X("C:/Seurat_fold(PFC)/H21.33.018_L2_3_IT")
seurat_5 <- CreateSeuratObject(counts = sample_5, project = "H21.33.018_L2_3_IT")
...
# 处理 sample_6
sample_6 <- Read10X("C:/Seurat_fold(PFC)/H21.33.019_L2_3_IT")
seurat_6 <- CreateSeuratObject(counts = sample_6, project = "H21.33.019_L2_3_IT")
...
# 处理 sample_7
sample_7 <- Read10X("C:/Seurat_fold(PFC)/H21.33.020_L2_3_IT")
seurat_7 <- CreateSeuratObject(counts = sample_7, project = "H21.33.020_L2_3_IT")
...
# 处理 sample_8
sample_8 <- Read10X("C:/Seurat_fold(PFC)/H21.33.021_L2_3_IT")
seurat_8 <- CreateSeuratObject(counts = sample_8, project = "H21.33.021_L2_3_IT")
...
# 处理 sample_9
sample_9 <- Read10X("C:/Seurat_fold(PFC)/H21.33.022_L2_3_IT")
seurat_9 <- CreateSeuratObject(counts = sample_9, project = "H21.33.022_L2_3_IT")
...
# 处理 sample_10
sample_10 <- Read10X("C:/Seurat_fold(PFC)/H21.33.023_L2_3_IT")
seurat_10 <- CreateSeuratObject(counts = sample_10, project = "H21.33.023_L2_3_IT")
...
# 处理 sample_11
sample_11 <- Read10X("C:/Seurat_fold(PFC)/H21.33.025_L2_3_IT")
seurat_11 <- CreateSeuratObject(counts = sample_11, project = "H21.33.025_L2_3_IT")
...
# 处理 sample_12
sample_12 <- Read10X("C:/Seurat_fold(PFC)/H21.33.026_L2_3_IT")
seurat_12 <- CreateSeuratObject(counts = sample_12, project = "H21.33.026_L2_3_IT")
...
# 处理 sample_13
sample_13 <- Read10X("C:/Seurat_fold(PFC)/H21.33.027_L2_3_IT")
seurat_13 <- CreateSeuratObject(counts = sample_13, project = "H21.33.027_L2_3_IT")
...
# 处理 sample_14
sample_14 <- Read10X("C:/Seurat_fold(PFC)/H21.33.028_L2_3_IT")
seurat_14 <- CreateSeuratObject(counts = sample_14, project = "H21.33.028_L2_3_IT")
...
# 处理 sample_15
sample_15 <- Read10X("C:/Seurat_fold(PFC)/H21.33.029_L2_3_IT")
seurat_15 <- CreateSeuratObject(counts = sample_15, project = "H21.33.029_L2_3_IT")
...
# 处理 sample_16
sample_16 <- Read10X("C:/Seurat_fold(PFC)/H21.33.030_L2_3_IT")
seurat_16 <- CreateSeuratObject(counts = sample_16, project = "H21.33.030_L2_3_IT")
...
# 处理 sample_17
sample_17 <- Read10X("C:/Seurat_fold(PFC)/H21.33.031_L2_3_IT")
seurat_17 <- CreateSeuratObject(counts = sample_17, project = "H21.33.031_L2_3_IT")
...
# 处理 sample_18
sample_18 <- Read10X("C:/Seurat_fold(PFC)/H21.33.032_L2_3_IT")
seurat_18 <- CreateSeuratObject(counts = sample_18, project = "H21.33.032_L2_3_IT")
...
# 处理 sample_19
sample_19 <- Read10X("C:/Seurat_fold(PFC)/H21.33.033_L2_3_IT")
seurat_19 <- CreateSeuratObject(counts = sample_19, project = "H21.33.033_L2_3_IT")
...
# 处理 sample_20
sample_20 <- Read10X("C:/Seurat_fold(PFC)/H21.33.034_L2_3_IT")
seurat_20 <- CreateSeuratObject(counts = sample_20, project = "H21.33.034_L2_3_IT")
...
# 处理 sample_21
sample_21 <- Read10X("C:/Seurat_fold(PFC)/H21.33.035_L2_3_IT")
seurat_21 <- CreateSeuratObject(counts = sample_21, project = "H21.33.035_L2_3_IT")
...
# 处理 sample_22
sample_22 <- Read10X("C:/Seurat_fold(PFC)/H21.33.036_L2_3_IT")
seurat_22 <- CreateSeuratObject(counts = sample_22, project = "H21.33.036_L2_3_IT")
...
# 处理 sample_23
sample_23 <- Read10X("C:/Seurat_fold(PFC)/H21.33.037_L2_3_IT")
seurat_23 <- CreateSeuratObject(counts = sample_23, project = "H21.33.037_L2_3_IT")
...
# 处理 sample_24
sample_24 <- Read10X("C:/Seurat_fold(PFC)/H21.33.038_L2_3_IT")
seurat_24 <- CreateSeuratObject(counts = sample_24, project = "H21.33.038_L2_3_IT")
...
# 处理 sample_26
sample_26 <- Read10X("C:/Seurat_fold(PFC)/H21.33.040_L2_3_IT")
seurat_26 <- CreateSeuratObject(counts = sample_26, project = "H21.33.040_L2_3_IT")
...
# 处理 sample_27
sample_27 <- Read10X("C:/Seurat_fold(PFC)/H21.33.041_L2_3_IT")
seurat_27 <- CreateSeuratObject(counts = sample_27, project = "H21.33.041_L2_3_IT")
...
# 处理 sample_29
sample_29 <- Read10X("C:/Seurat_fold(PFC)/H21.33.043_L2_3_IT")
seurat_29 <- CreateSeuratObject(counts = sample_29, project = "H21.33.043_L2_3_IT")
...
# 处理 sample_30
sample_30 <- Read10X("C:/Seurat_fold(PFC)/H21.33.044_L2_3_IT")
seurat_30 <- CreateSeuratObject(counts = sample_30, project = "H21.33.044_L2_3_IT")
...
# 处理 sample_31
sample_31 <- Read10X("C:/Seurat_fold(PFC)/H21.33.045_L2_3_IT")
seurat_31 <- CreateSeuratObject(counts = sample_31, project = "H21.33.045_L2_3_IT")
...
# 处理 sample_32
sample_32 <- Read10X("C:/Seurat_fold(PFC)/H21.33.046_L2_3_IT")
seurat_32 <- CreateSeuratObject(counts = sample_32, project = "H21.33.046_L2_3_IT")
...
# 处理 sample_33
sample_33 <- Read10X("C:/Seurat_fold(PFC)/H21.33.047_L2_3_IT")
seurat_33 <- CreateSeuratObject(counts = sample_33, project = "H21.33.047_L2_3_IT")
...
# 处理 sample_34
sample_34 <- Read10X("C:/Seurat_fold(PFC)/H18.30.002_L2_3_IT")
seurat_34 <- CreateSeuratObject(counts = sample_34, project = "H18.30.002_L2_3_IT")
...
# 处理 sample_35
sample_35 <- Read10X("C:/Seurat_fold(PFC)/H19.30.001_L2_3_IT")
seurat_35 <- CreateSeuratObject(counts = sample_35, project = "H19.30.001_L2_3_IT")
...
# 处理 sample_36
sample_36 <- Read10X("C:/Seurat_fold(PFC)/H20.33.001_L2_3_IT")
seurat_36 <- CreateSeuratObject(counts = sample_36, project = "H20.33.001_L2_3_IT")
...
# 处理 sample_37
sample_37 <- Read10X("C:/Seurat_fold(PFC)/H20.33.002_L2_3_IT")
seurat_37 <- CreateSeuratObject(counts = sample_37, project = "H20.33.002_L2_3_IT")
...
# 处理 sample_38
sample_38 <- Read10X("C:/Seurat_fold(PFC)/H20.33.004_L2_3_IT")
seurat_38 <- CreateSeuratObject(counts = sample_38, project = "H20.33.004_L2_3_IT")
...
# 处理 sample_39
sample_39 <- Read10X("C:/Seurat_fold(PFC)/H20.33.005_L2_3_IT")
seurat_39 <- CreateSeuratObject(counts = sample_39, project = "H20.33.005_L2_3_IT")
...
# 处理 sample_40
sample_40 <- Read10X("C:/Seurat_fold(PFC)/H20.33.008_L2_3_IT")
seurat_40 <- CreateSeuratObject(counts = sample_40, project = "H20.33.008_L2_3_IT")
...
# 处理 sample_41
sample_41 <- Read10X("C:/Seurat_fold(PFC)/H20.33.011_L2_3_IT")
seurat_41 <- CreateSeuratObject(counts = sample_41, project = "H20.33.011_L2_3_IT")
...
# 处理 sample_42
sample_42 <- Read10X("C:/Seurat_fold(PFC)/H20.33.012_L2_3_IT")
seurat_42 <- CreateSeuratObject(counts = sample_42, project = "H20.33.012_L2_3_IT")
...
# 处理 sample_43
sample_43 <- Read10X("C:/Seurat_fold(PFC)/H20.33.013_L2_3_IT")
seurat_43 <- CreateSeuratObject(counts = sample_43, project = "H20.33.013_L2_3_IT")
...
# 处理 sample_44
sample_44 <- Read10X("C:/Seurat_fold(PFC)/H20.33.014_L2_3_IT")
seurat_44 <- CreateSeuratObject(counts = sample_44, project = "H20.33.014_L2_3_IT")
...
# 处理 sample_45
sample_45 <- Read10X("C:/Seurat_fold(PFC)/H20.33.015_L2_3_IT")
seurat_45 <- CreateSeuratObject(counts = sample_45, project = "H20.33.015_L2_3_IT")
...
# 处理 sample_46
sample_46 <- Read10X("C:/Seurat_fold(PFC)/H20.33.016_L2_3_IT")
seurat_46 <- CreateSeuratObject(counts = sample_46, project = "H20.33.016_L2_3_IT")
...
# 处理 sample_47
sample_47 <- Read10X("C:/Seurat_fold(PFC)/H20.33.017_L2_3_IT")
seurat_47 <- CreateSeuratObject(counts = sample_47, project = "H20.33.017_L2_3_IT")
...
# 处理 sample_48
sample_48 <- Read10X("C:/Seurat_fold(PFC)/H20.33.018_L2_3_IT")
seurat_48 <- CreateSeuratObject(counts = sample_48, project = "H20.33.018_L2_3_IT")
...
# 处理 sample_49
sample_49 <- Read10X("C:/Seurat_fold(PFC)/H20.33.019_L2_3_IT")
seurat_49 <- CreateSeuratObject(counts = sample_49, project = "H20.33.019_L2_3_IT")
...
# 处理 sample_50
sample_50 <- Read10X("C:/Seurat_fold(PFC)/H20.33.020_L2_3_IT")
seurat_50 <- CreateSeuratObject(counts = sample_50, project = "H20.33.020_L2_3_IT")
...
# 处理 sample_51
sample_51 <- Read10X("C:/Seurat_fold(PFC)/H20.33.024_L2_3_IT")
seurat_51 <- CreateSeuratObject(counts = sample_51, project = "H20.33.024_L2_3_IT")
...
# 处理 sample_52
sample_52 <- Read10X("C:/Seurat_fold(PFC)/H20.33.025_L2_3_IT")
seurat_52 <- CreateSeuratObject(counts = sample_52, project = "H20.33.025_L2_3_IT")
...
# 处理 sample_53
sample_53 <- Read10X("C:/Seurat_fold(PFC)/H20.33.026_L2_3_IT")
seurat_53 <- CreateSeuratObject(counts = sample_53, project = "H20.33.026_L2_3_IT")
...
# 处理 sample_54
sample_54 <- Read10X("C:/Seurat_fold(PFC)/H20.33.027_L2_3_IT")
seurat_54 <- CreateSeuratObject(counts = sample_54, project = "H20.33.027_L2_3_IT")
...
# 处理 sample_55
sample_55 <- Read10X("C:/Seurat_fold(PFC)/H20.33.028_L2_3_IT")
seurat_55 <- CreateSeuratObject(counts = sample_55, project = "H20.33.028_L2_3_IT")
...
# 处理 sample_56
sample_56 <- Read10X("C:/Seurat_fold(PFC)/H20.33.029_L2_3_IT")
seurat_56 <- CreateSeuratObject(counts = sample_56, project = "H20.33.029_L2_3_IT")
...
# 处理 sample_57
sample_57 <- Read10X("C:/Seurat_fold(PFC)/H20.33.030_L2_3_IT")
seurat_57 <- CreateSeuratObject(counts = sample_57, project = "H20.33.030_L2_3_IT")
...
# 处理 sample_58
sample_58 <- Read10X("C:/Seurat_fold(PFC)/H20.33.031_L2_3_IT")
seurat_58 <- CreateSeuratObject(counts = sample_58, project = "H20.33.031_L2_3_IT")
...
# 处理 sample_59
sample_59 <- Read10X("C:/Seurat_fold(PFC)/H20.33.032_L2_3_IT")
seurat_59 <- CreateSeuratObject(counts = sample_59, project = "H20.33.032_L2_3_IT")
...
# 处理 sample_60
sample_60 <- Read10X("C:/Seurat_fold(PFC)/H20.33.033_L2_3_IT")
seurat_60 <- CreateSeuratObject(counts = sample_60, project = "H20.33.033_L2_3_IT")
...
# 处理 sample_61
sample_61 <- Read10X("C:/Seurat_fold(PFC)/H20.33.034_L2_3_IT")
seurat_61 <- CreateSeuratObject(counts = sample_61, project = "H20.33.034_L2_3_IT")
...
# 处理 sample_62
sample_62 <- Read10X("C:/Seurat_fold(PFC)/H20.33.035_L2_3_IT")
seurat_62 <- CreateSeuratObject(counts = sample_62, project = "H20.33.035_L2_3_IT")
...
# 处理 sample_63
sample_63 <- Read10X("C:/Seurat_fold(PFC)/H20.33.036_L2_3_IT")
seurat_63 <- CreateSeuratObject(counts = sample_63, project = "H20.33.036_L2_3_IT")
...
# 处理 sample_64
sample_64 <- Read10X("C:/Seurat_fold(PFC)/H20.33.037_L2_3_IT")
seurat_64 <- CreateSeuratObject(counts = sample_64, project = "H20.33.037_L2_3_IT")
...
# 处理 sample_65
sample_65 <- Read10X("C:/Seurat_fold(PFC)/H20.33.038_L2_3_IT")
seurat_65 <- CreateSeuratObject(counts = sample_65, project = "H20.33.038_L2_3_IT")
...
# 处理 sample_66
sample_66 <- Read10X("C:/Seurat_fold(PFC)/H20.33.039_L2_3_IT")
seurat_66 <- CreateSeuratObject(counts = sample_66, project = "H20.33.039_L2_3_IT")
...
# 处理 sample_67
sample_67 <- Read10X("C:/Seurat_fold(PFC)/H20.33.040_L2_3_IT")
seurat_67 <- CreateSeuratObject(counts = sample_67, project = "H20.33.040_L2_3_IT")
...
# 处理 sample_68
sample_68 <- Read10X("C:/Seurat_fold(PFC)/H20.33.041_L2_3_IT")
seurat_68 <- CreateSeuratObject(counts = sample_68, project = "H20.33.041_L2_3_IT")
...
# 处理 sample_69
sample_69 <- Read10X("C:/Seurat_fold(PFC)/H20.33.044_L2_3_IT")
seurat_69 <- CreateSeuratObject(counts = sample_69, project = "H20.33.044_L2_3_IT")
...
# 处理 sample_70
sample_70 <- Read10X("C:/Seurat_fold(PFC)/H20.33.045_L2_3_IT")
seurat_70 <- CreateSeuratObject(counts = sample_70, project = "H20.33.045_L2_3_IT")
...
# 处理 sample_71
sample_71 <- Read10X("C:/Seurat_fold(PFC)/H20.33.046_L2_3_IT")
seurat_71 <- CreateSeuratObject(counts = sample_71, project = "H20.33.046_L2_3_IT")
...
# 处理 sample_72
sample_72 <- Read10X("C:/Seurat_fold(PFC)/H21.33.001_L2_3_IT")
seurat_72 <- CreateSeuratObject(counts = sample_72, project = "H21.33.001_L2_3_IT")
...
# 处理 sample_73
sample_73 <- Read10X("C:/Seurat_fold(PFC)/H21.33.002_L2_3_IT")
seurat_73 <- CreateSeuratObject(counts = sample_73, project = "H21.33.002_L2_3_IT")
...
# 处理 sample_74
sample_74 <- Read10X("C:/Seurat_fold(PFC)/H21.33.003_L2_3_IT")
seurat_74 <- CreateSeuratObject(counts = sample_74, project = "H21.33.003_L2_3_IT")
...
# 处理 sample_75
sample_75 <- Read10X("C:/Seurat_fold(PFC)/H21.33.004_L2_3_IT")
seurat_75 <- CreateSeuratObject(counts = sample_75, project = "H21.33.004_L2_3_IT")
...
# 处理 sample_76
sample_76 <- Read10X("C:/Seurat_fold(PFC)/H21.33.005_L2_3_IT")
seurat_76 <- CreateSeuratObject(counts = sample_76, project = "H21.33.005_L2_3_IT")
...
# 处理 sample_77
sample_77 <- Read10X("C:/Seurat_fold(PFC)/H21.33.006_L2_3_IT")
seurat_77 <- CreateSeuratObject(counts = sample_77, project = "H21.33.006_L2_3_IT")
...
# 处理 sample_78
sample_78 <- Read10X("C:/Seurat_fold(PFC)/H21.33.007_L2_3_IT")
seurat_78 <- CreateSeuratObject(counts = sample_78, project = "H21.33.007_L2_3_IT")
...
# 处理 sample_79
sample_79 <- Read10X("C:/Seurat_fold(PFC)/H21.33.008_L2_3_IT")
seurat_79 <- CreateSeuratObject(counts = sample_79, project = "H21.33.008_L2_3_IT")
...
# 处理 sample_81
sample_81 <- Read10X("C:/Seurat_fold(PFC)/H21.33.012_L2_3_IT")
seurat_81 <- CreateSeuratObject(counts = sample_81, project = "H21.33.012_L2_3_IT")
...
# 处理 sample_82
sample_82 <- Read10X("C:/Seurat_fold(PFC)/H21.33.013_L2_3_IT")
seurat_82 <- CreateSeuratObject(counts = sample_82, project = "H21.33.013_L2_3_IT")
...
dementia_merged <- merge(
  seurat_3_downsampled, 
  y = c(
    seurat_4_downsampled, seurat_5_downsampled, seurat_7_downsampled, 
    seurat_8_downsampled, seurat_13_downsampled, seurat_15_downsampled, 
    seurat_17_downsampled, seurat_20_downsampled, seurat_29_downsampled, 
    seurat_30_downsampled, seurat_31_downsampled, seurat_32_downsampled, 
    seurat_34_downsampled, seurat_35_downsampled, seurat_36_downsampled, 
    seurat_37_downsampled, seurat_38_downsampled, seurat_39_downsampled, 
    seurat_40_downsampled, seurat_41_downsampled, seurat_42_downsampled, 
    seurat_43_downsampled, seurat_44_downsampled, seurat_45_downsampled, 
    seurat_46_downsampled, seurat_47_downsampled, seurat_48_downsampled, 
    seurat_50_downsampled, seurat_53_downsampled, seurat_55_downsampled, 
    seurat_56_downsampled, seurat_58_downsampled, seurat_60_downsampled, 
    seurat_64_downsampled, seurat_65_downsampled, seurat_67_downsampled, 
    seurat_68_downsampled, seurat_70_downsampled, seurat_71_downsampled, 
    seurat_73_downsampled, seurat_76_downsampled, seurat_78_downsampled, 
    seurat_79_downsampled, seurat_81_downsampled, seurat_82_downsampled
  ),
  add.cell.ids = paste0("Dementia_",1:46),
  project = "DementiaIntegrated")


no_dementia_merged <- merge(
  seurat_1_downsampled, 
  y = c(
    seurat_2_downsampled, seurat_6_downsampled, seurat_9_downsampled, 
    seurat_10_downsampled, seurat_11_downsampled, seurat_12_downsampled, 
    seurat_14_downsampled, seurat_16_downsampled, seurat_18_downsampled, 
    seurat_19_downsampled, seurat_21_downsampled, seurat_22_downsampled, 
    seurat_23_downsampled, seurat_24_downsampled, seurat_26_downsampled, 
    seurat_27_downsampled, seurat_33_downsampled, seurat_49_downsampled, 
    seurat_51_downsampled, seurat_52_downsampled, seurat_54_downsampled, 
    seurat_57_downsampled, seurat_59_downsampled, seurat_61_downsampled, 
    seurat_62_downsampled, seurat_63_downsampled, seurat_66_downsampled, 
    seurat_69_downsampled, seurat_74_downsampled, seurat_75_downsampled, 
    seurat_77_downsampled
  ),
  add.cell.ids = paste0("NoDementia_",1:32),
...
conditions <- c(
  rep("no dementia", length(Cells(seurat_1_downsampled))),
  rep("no dementia", length(Cells(seurat_2_downsampled))),
  rep("dementia", length(Cells(seurat_3_downsampled))),
  rep("dementia", length(Cells(seurat_4_downsampled))),
  rep("dementia", length(Cells(seurat_5_downsampled))),
  rep("no dementia", length(Cells(seurat_6_downsampled))),
  rep("dementia", length(Cells(seurat_7_downsampled))),
  ...
  rep("no dementia", length(Cells(seurat_11_downsampled))),
  rep("no dementia", length(Cells(seurat_12_downsampled))),
  rep("dementia", length(Cells(seurat_13_downsampled))),
  ...
  rep("no dementia", length(Cells(seurat_23_downsampled))),
  rep("no dementia", length(Cells(seurat_24_downsampled))),
  rep("no dementia", length(Cells(seurat_26_downsampled))),
  rep("no dementia", length(Cells(seurat_27_downsampled))),
  rep("dementia", length(Cells(seurat_29_downsampled))),
